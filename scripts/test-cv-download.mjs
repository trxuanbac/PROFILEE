...
assert.match(
  heroVue,
  /const cvPagePath = `\$\{import\.meta\.env\.BASE_URL\}files\/CV-Tran-Xuan-Bac\.html\?v=20260922-cv`;/,
...
assert.match(
  cvHtml,
  /<a\s+href="\.\/CV-Tran-Xuan-Bac-2026\.pdf\?v=20260922-cv"\s+download="CV-Tran-Xuan-Bac-2026\.pdf"\s+onclick="downloadPdf\(event\)">Tải CV PDF<\/a>/,
